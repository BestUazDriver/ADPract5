...
public class Main {
    ...
    private static String path = "C:\\Users\\admin\\IdeaProjects\\src\\ADPract5\\src\\main\\resources\\med.txt";
...
//            while ((line = bufferedReader.readLine())!=null){
            for (int i = 0; i < 3; i++) {
                ...
                LocalDate mdrdLstDate = LocalDate.of(Integer.parseInt(mdrdLastParse[2]), Integer.parseInt(mdrdLastParse[0]), Integer.parseInt(mdrdLastParse[1]));
                ...
                LocalDate glucoseFastingLastDate = LocalDate.of(Integer.parseInt(glucoseFastingLastDateParse[2]), Integer.parseInt(glucoseFastingLastDateParse[0]), Integer.parseInt(glucoseFastingLastDateParse[1]));
                double cholesterol;
                if (params[11].equals("")){
                    cholesterol = 0;
                }else{
